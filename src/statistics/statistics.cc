...
void statistics::initialize(){
    ...
    rcaches = new base_cache*[num_nodes];
    ...
    for (int i = 0;i<topo.getNumNodes();i++){
        ...
        rcaches[i] = (base_cache *) (topo.getNode(i)->getModule()->getModuleByRelativePath("rcontent_store"));
    ...
    switch (in->getKind()){
        case FULL_CHECK:
            ...
            {//"5,6,7,9,10,11,13,14,15"
                ...
                }else{full += (int)caches[i]->full();}
            }


            //full += (int)(caches[i]->full()&& rcaches[i]->full());

//cout<<"full "<<full<<" partial_n "<<partial_n <<endl;
