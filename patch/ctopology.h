...
//private:
  ...
  //@}
        ...
        //@}
        /** @name Result of cluster info extraction. */
            //@{
            int getCluster_id() const  {return clu_id2;}
            void setCluster_id(int z)  {clu_id2=z;}

        int getGw() const  {return gw;}
            void setGw(int z)  {gw=z;}
 int getR_name() const  {return router_name;}
            void setR_name(int z)  {router_name=z;}

            int getR_type() const  {return r_type;}
                       void setR_type(int z)  {r_type=z;}
        //@}
