    ...
    for (int mod_id=0; mod_id<=simulation.getLastModuleId(); mod_id++)
    {
        ...
        if (mod && selfunc(mod,data))
        {
            ...
            temp_nodev[k].clu_id2 = 0;
                       ...
                       if(k==2)  {temp_nodev[k].clu_id2 = 1;}//test
                   ...
                   temp_nodev[k].router_name = 0;
                      ...
                      if(k==2){temp_nodev[k].router_name = 1;}
                      if(k==3){temp_nodev[k].router_name = 2;}
                      if(k==4){temp_nodev[k].router_name = 3;}
                      if(k==5){temp_nodev[k].router_name = 4;}
                      if(k==6){temp_nodev[k].router_name = 0;}
                      if(k==7){temp_nodev[k].router_name = 1;}
                      if(k==8){temp_nodev[k].router_name = 2;}
                      if(k==9){temp_nodev[k].router_name = 3;}
                      if(k==10){temp_nodev[k].router_name = 4;}
